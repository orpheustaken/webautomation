...
public class DriverFactory {
    ...
    public static WebDriver getDriver() {
        ...
        if(driver == null) {
            ...
            if(osUtils.isLinux()) {
                switch (Properties.browser) {
                    case FIREFOX: System.setProperty("webdriver.gecko.driver", projectPath + "/src/main/java/selenium_cucumber/Browser/Drivers/geckodriver");
                    driver = new FirefoxDriver();break;
                    case CHROME: System.setProperty("webdriver.chrome.driver", projectPath + "/src/main/java/selenium_cucumber/Browser/Drivers/chromedriver");
                    driver = new ChromeDriver();break;
                }
            }
         }
